    				...
    				<div className="cv-section cv-header">
      					...
      					<div className="cv-header-meta">
        					<div className="cv-header-meta-right">
          						...
          						<div className="cv-header-meta-row">
            						<a href="http://qalfaki.github.io/q" rel="noopener noreferrer">qalfaki.github.io/q</a>
          						</div>
        					</div>
      					</div>
    				</div>
                ...
                <h3 className="cv-section-title">Experience</h3>
                    <div className="cv-section-content">
                            ...
                            <div className="cv-timeline-row">
                                    ...
                                    <p>Developed new web applications for managing large volumes of data,  backend to frontend and deployment.</p>
                                    <ul>
                                        ...
                                        <li>Introduced code style guidelines, directory structure and formats.</li>
                                    </ul>
                                </div>
						                </div>
                        </div>
                            ...
                            <div className="cv-timeline-row">
                                ...
                                <div className="cv-timeline-body">
                                    ...
                                    <ul>
                                        ...
                                        <li>Wrote automatic synchronizations with remote APIs, that e.g. parse user's data, music genres.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                      ...
                                      <div className="cv-section-content">
                                        <div className="cv-timeline">
                                          <div className="cv-timeline-row">
                                            ...
                                            <div className="cv-timeline-body">
                                              <div className="cv-timeline-position">Diploma in Mechanical Engineering</div>
                                              <ul>
                                                <li>Worked on various projects involved Hydraulics and Thermodynamics systems, including computerized system diagnoses and software contribution to mechanics workflow</li>
                                              </ul>
                                            </div>
                                          </div>
                                        </div>
